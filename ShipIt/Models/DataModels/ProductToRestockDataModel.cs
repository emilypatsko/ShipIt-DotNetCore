...
{
    public class ProductToRestockDataModel : DataModel
    {
        ...
        public ProductToRestockDataModel(IDataReader dataReader): base(dataReader) { }
        
        public ProductToRestockDataModel() {}
    }
}